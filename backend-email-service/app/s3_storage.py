...
class S3StorageService:
    ...
    def upload_attachment(
        ...
        try:
            ...
            # Organize files by date and complaint ID
    ...
    def get_storage_stats(self) -> dict:
        ...
        try:
            ...
            # For production, you might want to use CloudWatch metrics instead
            paginator = self.s3_client.get_paginator('list_objects_v2')
            total_size = 0
            total_objects = 0
            
            for page in paginator.paginate(Bucket=self.bucket_name, Prefix="attachments/"):
                if 'Contents' in page:
